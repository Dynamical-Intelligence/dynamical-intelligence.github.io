...
profiles:
  ...
  - align: right
    ...
    category: lead
    active: true
    image: members/iran_roman.jpg
    content: members_bios/iran_roman.md
    image_circular: true # crops the image to make it circular
    website: https://iranroman.github.io/
  ...
  - align: right
    ...
    category: ra
    active: true
    content: members_bios/jimena_arruti.md
    image_circular: true # crops the image to make it circular
  ...
  - align: right
    ...
    active: false
    papers:
      - bombiccipontelli2026conditional
    content: members_bios/template.md
    image_circular: true
  ...
  - align: right
    ...
    university_secondary: University of Cambridge
    category: ra
    active: false
    papers:
      - cheston2025audiblelight
    content: members_bios/template.md
    image_circular: true
---
