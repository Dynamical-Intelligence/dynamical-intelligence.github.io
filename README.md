## DISL site guide: where to edit things
...
**Formatting:** this repo uses [Prettier](https://prettier.io/) to keep formatting consistent. Before committing, run:

```bash
npx prettier . --check    # see which files need formatting
npx prettier . --write    # fix them
```
